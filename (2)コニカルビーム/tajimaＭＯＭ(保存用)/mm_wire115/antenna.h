...
void Calculation(void)
{
	...
	//--全セグメント数設定
	n_pole = int(2.0*(nbun_pole1_2+nbun_pole2_2+nbun_pole3_2+1+1+1) + (nbun_pole4*2+1+1));
	...
	//========================================================
	PARA1 = r_pole1_2/RAMDA0;
	PARA2 =	r_pole1_2/RAMDA0;
...
//------------------------------------------------⑩反射板------------------------------------------------------------
	...
	for(j = 0; j<nbun_pole1_2+nbun_pole2_2+nbun_pole3_2+1+1+1; ++j){
		//--計算結果代入
		RX[i] = RX[j];											//始点位置x
		RY[i] = RY[j];											//始点位置y
		RZ[i] = (-1.0)*RZ[j];									//始点位置z
...
//--------------------------------------------------------------------------------------------------------------------
	...
	//　↓　オーバーラップ込みで　↓
	SEGN[0] = nbun_pole1_2 +1;
	SEGN[1] = nbun_pole2_2 +1;
	SEGN[2] = nbun_pole3_2 +1;

	SEGN[3] = nbun_pole1_2 +1;
	SEGN[4] = nbun_pole2_2 +1;
	SEGN[5] = nbun_pole3_2 +1;

	SEGN[6] = nbun_pole4*2 +2;
	...
	//					第１給電以外で制御を行う．
	//========================================================
	FEDP[0] = SEGN[0]+SEGN[1]+SEGN[2]+SEGN[3]+SEGN[4]+SEGN[5]-6+(SEGN[6]-2)/2+1-1;
